...
var _AbFragment_setupFinished, _AlternativeContainer_container, _AlternativeContainer_lower_container, _AbInfoButton_container;
Object.defineProperty(exports, "__esModule", { value: true });
exports.AbFragment = void 0;
const json_data_ts_1 = require("../json_data.ts");
...
class AbFragment extends HTMLElement {
    constructor() {
        super();
        _AbFragment_setupFinished.set(this, void 0);
        this.get_data();
    ...
    set_height() {
        ...
        this.style.height = (this.containers[this.current_display_id].firstElementChild.clientHeight + (0, helpers_ts_1.convert_rem_to_pixels)(0.5)) + "px";
    }
    set_arrow_right_listener() {
        if (this.arrow_right_area.hasClickListener)
            return;
...
exports.AbFragment = AbFragment;
_AbFragment_setupFinished = new WeakMap();
/**
...
class AlternativeContainer {
    constructor(single_alternative_data) {
        _AlternativeContainer_container.set(this, void 0);
        _AlternativeContainer_lower_container.set(this, void 0);
        __classPrivateFieldSet(this, _AlternativeContainer_container, document.createElement("div"), "f");
        __classPrivateFieldGet(this, _AlternativeContainer_container, "f").classList.add("ab-fragment_alternative_upper_container");
        __classPrivateFieldSet(this, _AlternativeContainer_lower_container, document.createElement("div"), "f");
        __classPrivateFieldGet(this, _AlternativeContainer_lower_container, "f").classList.add("ab-fragment_alternative_lower_container");
        __classPrivateFieldGet(this, _AlternativeContainer_container, "f").appendChild(__classPrivateFieldGet(this, _AlternativeContainer_lower_container, "f"));
    ...
    get container() {
        return __classPrivateFieldGet(this, _AlternativeContainer_container, "f");
    }
    get lower_container() {
        return __classPrivateFieldGet(this, _AlternativeContainer_lower_container, "f");
    }
...
_AlternativeContainer_container = new WeakMap(), _AlternativeContainer_lower_container = new WeakMap();
/**
...
class AbInfoButton {
    constructor(single_alternative_data) {
        _AbInfoButton_container.set(this, void 0);
        this.data = single_alternative_data;
        this.connected_antibiotic = json_data_ts_1.ANTIBIOTICS[this.data.antibiotic];
        __classPrivateFieldSet(this, _AbInfoButton_container, document.createElement("div"), "f");
    ...
    set_up_listener() {
        this.container.addEventListener('click', (e) => {
            constants_ts_1.popup.appendChild(this.popup_content);
            constants_ts_1.popup.classList.add("active");
    ...
    generate_popup_content() {
        ...
        if (this.connected_antibiotic.Sequenztherapie_Voraussetzungen) {
            ...
            sequence_pre.innerHTML = constants_ts_1.sequencePrerequisites[this.connected_antibiotic.Sequenztherapie_Voraussetzungen];
    ...
    get container() {
        return __classPrivateFieldGet(this, _AbInfoButton_container, "f");
    }
}
_AbInfoButton_container = new WeakMap();
